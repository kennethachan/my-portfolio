    ...
    <div>
      <div className="aboutme-container">
        ...
        <div className="about-details">
          ...
          <p className="brand">
            Enthusiastic Full Stack Developer based in the NYC area with a
            diverse background ranging from woodworking to architectural design.
            I am a creator. I am always curious. I have a strong ambition to
            create work that is -
