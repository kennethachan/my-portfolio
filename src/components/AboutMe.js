  ...
  return (
    <div className="aboutme-container">
      ...
      <div className="aboutme">
        ...
        <p className="brand">
          Enthusiastic Full Stack Software Engineer based in the NYC area with a
          diverse background ranging from woodworking to architectural design. I
          am a creator. I am always curious. I have a strong ambition to create
          work that is -
