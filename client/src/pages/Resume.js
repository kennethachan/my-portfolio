  ...
  return (
    <div>
      ...
      <div className="resume-container">
        ...
        <li className="res-list">
          <span className="bold-text">-</span>Completed 500+ hours of expert-led
          instruction in JavaScript, Python, MongoDB, Node, React, and hands-on
          learning of web and mobile application fundamentals using the
          industry's most in-demand technologies. Developed projects, including:
        </li>
        <li className="res-list">
        ...
        <li className="res-list">
          ...
          pokedex allows the user to randomly generate a pokemon card with stats
          and an image, user can type in a pokemon name to generate a specified
          pokemon card. Pokedex also features a dark mode option.
        </li>
        <li className="res-list">
          <span className="bold-text">-Tic Tac Toe:</span> Built with vanilla
          Javascript, HTML and CSS. A classic 2 player game with a gloomy night
          drive theme
        </li>

        <h4>
          Project Assistant (Estimator/Assistant Project Manager)| Ferra Designs
          | Brooklyn,NY
        </h4>
        ...
        <li className="res-list">
          <span className="bold-text">-</span>Coordinated and assisted post sale
          transition with PMs and Design Manager.
        </li>
        ...
        <li className="res-list">
          <span className="bold-text">-</span>Promoted from Assistant Estimator
          to Lead Estimator based on exemplary performance to provide fully
          developed budgets.
        </li>
        <li className="res-list">
          <span className="bold-text">-</span>Performed take off/ analyzed
        ...
        <li className="res-list">
          ...
          University of Hartford | Hartford,CT | September 2012 - May 2016 | 3.4
          GPA
        </li>
      </div>
    </div>
